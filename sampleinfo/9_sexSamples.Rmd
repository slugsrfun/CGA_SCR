...
```
Filtering samples that were genotyped at fewer than 100 (GTSeek) or 50% (LGC) SNPs from the set used for recapture analyses resulted in `r sum(sampleMetadata$FILT)` samples being removed from the dataset.  
