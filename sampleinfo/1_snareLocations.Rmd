...
Plot the traps and superimpose a 4km buffer (the size of the starting buffer in [Hooker et al. (2020)](https://doi.org/10.1002/jwmg.21887)). This buffer will not be used as the state space for subsequent analyses, but it does serve to illustrate the potential locations of activity centers in relation to the hair snares used in the study.    
```{r makePoly}
library(shapefiles)
