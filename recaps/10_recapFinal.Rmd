...
smd$region[which(smd$finalClone == 61)]
#Not really 2 regions, just historic sample
smd$region[which(smd$finalClone == 296)] 
#Not really 2 regions, just historic sample
```
...
which(discrepancy == TRUE)
#CloneIndex 30 - spotted above
table(smd$knownSEX[which(smd$finalClone == 30)])
#CloneIndex 45 - spotted previously, direct captured cub
table(smd$knownSEX[which(smd$finalClone == 45)])
#CloneIndex 144 - spotted above, direct capture agrees with majority - F
