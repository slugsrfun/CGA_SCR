...
points(locs[rownames(locs) %in% 
              Fsamps$utmSnare[which(Fsamps$cloneID == 7 & 
                                      Fsamps$snare == "HS 066")],], 
       pch = 19)
...
points(locs[rownames(locs) %in% 
              Fsamps$utmSnare[which(Fsamps$cloneID == 43 & 
                                      Fsamps$snare == "HS 126")],], 
       pch = 19)
...
kingrel$kinship[which(kingrel$id1 %in% 
                        Fsamps$vcfID[which(Fsamps$COLclone == 296)] & 
                        kingrel$id2 %in% 
                        Fsamps$vcfID[which(Fsamps$COLclone == 296)])]
...
kingrel$kinship[which(kingrel$id1 == "GTS_107-23" & 
                        kingrel$id2 %in% 
                        Fsamps$vcfID[which(Fsamps$cloneID ==43)])]
kingrel$kinship[which(kingrel$id1 %in% 
                        Fsamps$vcfID[which(Fsamps$cloneID ==43)] & 
                        kingrel$id2 == "GTS_107-23")]
